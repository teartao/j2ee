...
angular.module("highcharts-ng", []).directive("highchart", function () {
    ...
    }, f = ["xAxis", "yAxis"], g = function (c, d, e) {
        var g = {}, h = {chart: {events: {}}, title: {}, subtitle: {}, series: [], credits: {}, plotOptions: {}, navigator: {enabled: !1}};
    ...
    return{restrict: "EAC", replace: !0, template: "<div></div>", scope: {config: "="}, link: function (a, b) {
        var d = {}, k = function (b) {
            var f, g = [];
            if (b) {
                var h = e(b);
                ...
                if (angular.forEach(b, function (a) {
                    ...
                    var i = !1;
                    for (f = 0; f < b.length; f++)if (b[f].data && b[f].data.length > 0) {
                        i = !0;
                        break
                    }
