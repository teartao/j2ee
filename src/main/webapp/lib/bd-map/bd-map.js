window.VTC = {
    "ditu": {
        "normal": {"version": "082", "updateDate": "20150728"},
        "satellite": {"version": "009", "updateDate": "20150601"},
        "normalTraffic": {"version": "076", "updateDate": "20150724"},
        "satelliteTraffic": {"version": "078", "updateDate": "20150724"},
        "mapJS": {"version": "099", "updateDate": "20150728"},
        "satelliteStreet": {"version": "078", "updateDate": "20150724"},
        "panoClick": {"version": "1033", "updateDate": "201400823"},
        "panoUdt": {"version": "20150729", "updateDate": "20150729"},
...
window.BMAP_AUTHENTIC_KEY = "CiFFenbK5zdNZmBRFIbkyIQM";
(function () {
    function aa(a) {
        throw a;
    }
    ...
    w.lang.ra.prototype.removeEventListener = function (a, b) {
        if (w.lang.zs(b))b = b.DK; else if (!w.lang.dg(b))return;
        !this.mi && (this.mi = {});
        a.indexOf("on") != 0 && (a = "on" + a);
        var c = this.mi;
    ...
    w.extend(La.prototype, {
        la: function () {
            ...
            this.D.ho = o;
            this.an || (this.an = new bb({SJ: o}), this.Cg(this.an))
        }, yU: function () {
            this.D.ho = q;
            ...
            a ? this.Gr && this.Gr.Pf === a || (this.bh(this.Gr), this.Gr = new mb({geotableId: a}), this.Cg(this.Gr)) : this.bh(this.Gr)
        }, Hb: function () {
    ...
    var Rb = {
        ...
        style: "4lpoei",
        tile: "zyox4b",
        vectordrawlib: "cffzwf",
        newvectordrawlib: "mrrufl",
        ...
        navictrl: "pchtli",
        geoctrl: "wicvgf",
        copyrightctrl: "ishb1j",
        scommon: "ljigrp",
        local: "mlzowb",
        route: "xo55la",
        othersearch: "v13evs",
        mapclick: "f0l03h",
        buslinesearch: "bkl1nj",
        hotspot: "3zdzqm",
        autocomplete: "hy3fl3",
        coordtrans: "s5w2ur",
    ...
    function gb(a, b) {
        a && (this.wb = a, this.Q = "spot" + gb.Q++, b = b || {}, this.zg = b.text || "", this.Ou = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.oI = b.userData || p, this.wh = b.minZoom || p, this.kf = b.maxZoom || p)
    }
    ...
    w.extend(gb.prototype, {
        ...
        }, V: u("wb"), ct: ba("zg"), fD: u("zg"), setUserData: ba("oI"), getUserData: u("oI")
    });
    function Sb() {
        this.C = p;
        this.xb = "control";
    ...
    w.object.extend(bc.prototype, {
        fa: function (a, b) {
            ...
            if (a && !("menuitem" != a.xb || "" == a.zg || 0 >= a.Hi)) {
    ...
    w.extend(Bc.prototype, {
        fa: function () {
            ...
            var e = this;
            e.H_ = b;
            var f = this.map.ka(), g = e.gD(a, c), i = f.k.Cb, b = [a[0] * i + b[0], (-1 - a[1]) * i + b[1]], k = this.fg[g];
            k && k.sb ? (xb(k.sb, b), d && (d = new P(a[0], a[1]), f = this.map.D.fe ? this.map.D.fe.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ec(k, d)), k.loaded ? this.ef() : Fc(k, function () {
                e.ef()
            })) : (k = this.Li[g]) && k.sb ? (c.Db.insertBefore(k.sb, c.Db.lastChild), this.fg[g] = k, xb(k.sb, b), d && (d = new P(a[0], a[1]), f = this.map.D.fe ? this.map.D.fe.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ec(k, d)), k.loaded ? this.ef() : Fc(k, function () {
                e.ef()
            ...
            for (var b = this.km.concat(this.Hf), c = b.length, d = 0; d < c; d++) {
                ...
                if (!e.aH && !(e.Ho && !this.map.Hb() || e.aL && this.map.Hb())) {
                    ...
                    var y = this.fg, v = -this.OI.lng / t, x = this.OI.lat / t, t = [Math.ceil(v), Math.ceil(x)], n = l.U(), B;
                    for (B in y) {
                        var A = y[B], D = A.info;
            ...
            if (c instanceof bb)a && !c.em && (c.fa(this.map, this.Xc), c.em = o); else if (c.If && this.map.Cg(c.If), c.Ho) {
                for (a = 0; a < b.mg.length; a++)if (b.mg[a] == c)return;
            ...
            if (a instanceof bb)b && a.em && (a.remove(), a.em = q); else {
                ...
                if (a.Ho)for (var b = 0, c = this.mg.length; b < c; b++)a == this.mg[b] && this.mg.splice(b, 1); else {
                    b = 0;
    ...
    De.prototype = {
        fa: function () {
            ...
            this.$z = -(this.yg.offsetWidth - this.zn - this.Bk);
            this.Ju = this.Bk;
            this.yg.style.left = this.Ju + "px";
            this.yg.children[0] && (this.fr = this.yg.children[0].offsetWidth);
            ...
            w.F(this.vh, "click", function () {
                a.scrollTo(a.yg.offsetLeft + a.zn)
            });
            ...
            a = a < this.yg.offsetLeft ? Math.ceil((a - this.Bk - this.zn) / this.fr) * this.fr + this.zn + this.Bk - 8 : Math.ceil((a - this.Bk) / this.fr) * this.fr + this.Bk;
            a < this.$z ? a = this.$z : a > this.Ju && (a = this.Ju);
            var b = this.yg.offsetLeft, c = this;
            new sb({
